    ...
    public function show(Request $request, int $id)
{
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | La parcela no existe o el usuario no tiene acceso
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    return response()->json([
        'data' => [
            ...
            'arboles' => $parcela->arboles->map(function ($arbol) {
                return [
            ...
            'trozas' => $parcela->trozas->map(function ($troza) {
                return [
            ...
            'turnos_corta' => $parcela->turnosCorta->map(function ($turno) {
                return [
                    'id_turno' => $turno->id_turno,
                    'id_parcela' => $turno->id_parcela,
                    'codigo_corta' => $turno->codigo_corta,
                    'fecha_corta' => $turno->fecha_corta,
            ...
            'resumen' => [
                'total_arboles' => $parcela->arboles->count(),
                'total_trozas' => $parcela->trozas->count(),
                'total_turnos_corta' => $parcela->turnosCorta->count(),
            ],
        ],
    ]);
}
